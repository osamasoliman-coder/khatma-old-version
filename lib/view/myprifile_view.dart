                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            CustomText(
                              text:
                              'from ${controller.myKhatmaWithWerd[index]
                                  .khatmaName}',
                              fontSize: 17,
                        ...
                        ListView.builder(
                            itemCount:
                            controller.myKhatmaWithWerd[index].reserved.length,
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
                            itemBuilder: (context, position) {
                              return ListView.builder(
                                ...
                                physics: NeverScrollableScrollPhysics(),
                                itemCount: int.parse(
                                    controller.myKhatmaWithWerd[index]
                                        .reserved[position]['quran'].length
                                        .toString()),
                                itemBuilder: (context, quran) =>
                                    Column(
                                      children: [
                                        ( controller.myKhatmaWithWerd[index].reserved[position]['memberReservedEmail'] == _auth.currentUser.email )?
                                        Container(
                                          ...
                                          child: CustomText(
                                            ...
                                            text:controller
                                                ...
                                                .reserved[position]['quran'][quran]['quranEn'],
                                            fontSize: 18,
                                          ),
                                        ) : Container(),
                                      ],
                        ...
                        FlatButton(
                          onPressed: (){
                            controller.automationWerd(index);
                          },
                          child: Container(
                            decoration: BoxDecoration(
                                borderRadius:
